...
> **11. Python Support:** All packages must support minor Python versions released only within the past 42 months (3.5 years). Additionally, packages must support new minor Python versions within 6 months of their release (see [PHEP 3](https://github.com/heliophysicsPy/standards/pull/29)). 
