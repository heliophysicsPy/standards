...
The typical primary audience for PHEPs are the developers of PyHC packages.
...
The editors must post oronouncements of PHEP resolution to the PyHC mailing list.
